...
public class HashSet01 {
     ...
     set lerde foor each loop kullanılır
     hashing technigue = hashing teknik kullanarak hashcode üretir
     hash code tekrarsızdır

     *********   set deyince aklımıza tekrarsız elemanlar gelecek    *********
