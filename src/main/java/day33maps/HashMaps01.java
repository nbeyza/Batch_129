...
public class HashMaps01 {
                            ...
                            //tray catch = yepsini yakala



      /*
                          linkedList lerde eleman yerine Not kullanıır
                           Map larda Entry kullanılır

                           Map key value yapısında data depolamak için oluşturulan yeni bir structuredır "yapıdır"
                           data depoladığımız içim data structuredır "yapıdır"
                           Array ve LinkedList ve map data structuredır "yapıdır"
                           rastgele sıralar Randum
                           override = geçersiz kılma üzerine yazar
     ...
     */
     /*
        ...
        //multi thread aynı anda birden çok iş yapmak
        // akşama misafir gelecek aynı anda mantıklı bir sıra ile yemekleri yapmak


        Unique=benzersiz==Key deniliyor
        Repeated =tekrarlı olabilir==Value deniliyor

        set lerde foor each loop kullanılır keysetde de kullanılabilir  Maplarda çalışmaz

        putIfAbsent = varsa eklemez yoksa ekler
        put = üzerine yazar
        default = varsayılan , varolan
        null taplama yapmaz
    ...
    public static void main(String[] args) {
        ...
        Set<String> hmKeys = hm.keySet(); // java tekrarsızları set in içine koyar // sadece Keyleri almak için
        ...
        HashMap<String, Integer> salaries = new HashMap<>();                     //    salaries = maaşlar
