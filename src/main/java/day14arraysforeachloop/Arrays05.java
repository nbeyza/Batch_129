...
public class Arrays05 {
    public static void main(String[] args) {
        ...
        // array'de arama yapmadan öne sırlama yapmalıyız..
//ne olur nolmaz diye sort yapmak lazım. Atamanın kalıcı olması için.

       // Var mı yok mu? (Arrays.binarySearch(arrayin ismi,"aranan eleman")
